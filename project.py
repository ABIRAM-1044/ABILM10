...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.authorization_token = "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"
    ...
    def generate(self):
        ...
        self.pipe = StableDiffusionPipeline.from_pretrained(self.modelid, use_auth_token=self.authorization_token) 
